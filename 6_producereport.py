...
for produce, information in ProduceDictionary.items():
    stated_total=information['total']
    calculated_total=information['cost'] * information['amt_sold']
    if round(calculated_total, 2) != information['total']:
